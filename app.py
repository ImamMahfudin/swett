...
MONGODB_CONNECTION_STRING = "mongodb+srv://sirmis:silat123@cluster0.ph8qryg.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp"
client = MongoClient(MONGODB_CONNECTION_STRING)
db = client.dbsirmis_plus_week4
